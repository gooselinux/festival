...
# Delete ancient rhl config that gets in the way of enterprise linux
find -name 'ix86_RedHatLinux*.mak' -delete
...
%changelog
* Tue Jan 19 2010 Ray Strode <rstrode@redhat.com> - 1.96-18
Resolves: #553278
- Make work

* Fri Jan 15 2010 Ray Strode <rstrode@redhat.com> - 1.96-17
Resolves: #553278
- Fix build
